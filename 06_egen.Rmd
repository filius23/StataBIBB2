...
Mit `egen`, den "Extensions to generate", stehen eine ganze Menge an Funktionen zur Verfügung. 
Sehr hilfreich ist bspw. die Option `cut` zur Einteilung in Gruppen:
...
### numlist, varlist, varname {#listexpl}
